...
def test_predict():
    model_path = "/Users/cristianion/Desktop/satimg_model/models/dstl/dstl_model.pt"
    ...
    print(result.min())
    print(result.max())
    torchvision.utils.save_image(result, "samples/sample_dstl.png")
...
def test_multiple_predict():
    ...
    for file, name in files:
        ...
        torchvision.utils.save_image(result, f"out/{name}_{duration}.png")
